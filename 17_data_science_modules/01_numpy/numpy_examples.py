...
stypically a numeric type like FLOAT or INT.
'''
...
# print "np.identity(4, dtype = float)", np.identity(4, dtype = float)

# ''' For creating an unit matrix, eye function can be used. '''
# print "np.eye(4, k=1, dtype = float)", np.eye(4, k=1, dtype = float)
