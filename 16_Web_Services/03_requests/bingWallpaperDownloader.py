...
currentDate = (
    str(currentTime.year) + "0" + str(currentTime.month) + str(currentTime.day)
)
...
os.system(
    "gsettings set org.gnome.desktop.background picture-uri http://file:///home/radioactive/Bing/"
    + currentDate
    + ".jpg"
)
