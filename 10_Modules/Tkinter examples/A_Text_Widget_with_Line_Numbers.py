...
__changelog__ = (
    ...
    ("2009-07-24", "0.1", "PyTrash", """Initial version."""),
)
...
class EditorClass(object):
    ...
    def __init__(self, master):
        ...
        self.text = Text(
            self.frame, width=16, bd=0, padx=4, undo=True, background="white"
        )
    ...
    def updateAllLineNumbers(cls):
        ...
        cls.updateId = ed.text.after(cls.UPDATE_PERIOD, cls.updateAllLineNumbers)
