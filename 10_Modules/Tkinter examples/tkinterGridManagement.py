...
class App:
    def __init__(self, master):
        ...
        lbl_results_cmp = Label(
            master, text="Results comparison", wraplength=100, justify="left"
        )
        ...
        lbl_testall.grid(row=4, column=0, pady=row_pady, padx=column0_padx, sticky="w")
