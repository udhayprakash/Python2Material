...
print(
    "map(double, range(6))", list(map(double, list(range(6))))
)  # applying function for a list

db = lambda x: x * 2
print(db(12))
print(
    "map(db, range(6))    ", list(map(db, list(range(6))))
)  # applying lambda for a list
print(
...
print(
    list(map(addition, list(range(6)), list(range(6, 0, -1))))
)  # applying function for a list
print(
    list(map(addn, list(range(6)), list(range(6, 0, -1))))
)  # applying lambda for a list
